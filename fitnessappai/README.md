...
- **Домашний экран**: активная программа с ближайшим днём и его упражнениями,
  быстрый старт запланированной тренировки, последние 3 тренировки.
...
- **Программы**: конструктор на 1–7 дней с привязкой к дням недели, основной и
  ...
  активная программа для домашнего экрана.
...
- **Настройки**: переключение светлой/тёмной темы, ручной экспорт/импорт файла БД
  (интерфейс `SyncService` рассчитан на будущую облачную синхронизацию).
- **LLM (после MVP)**: интерфейс генерации упражнений + JSON-контракт
  (`docs/llm_contract.md`), заглушка вместо реальной модели, экспорт программы
  и истории в JSON.
...
lib/
  ...
  core/
    ...
    home/             # ui/ (домашний экран: активная программа, история)
