...
/// Пиктограмма группы мышц на основе добавленных ассетов.
class MuscleGroupIcon extends StatelessWidget {
  ...
  /// Ключ мышечной группы (например, 'arms', 'back', 'legs', 'shoulders',
  /// 'shoulders_front', 'chest', 'abs', 'neck', 'rest').
  final String muscleKey;
  final double size;
  final Color? color;

  /// Путь к ассету по ключу группы (тестовый хук).
  @visibleForTesting
  ...
  Widget build(BuildContext context) {
    final path = assetPathFor(muscleKey);
    return ClipRRect(
