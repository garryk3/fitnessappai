...
class WorkoutRepository {
  ...
  WorkoutSetResultsCompanion _toResultCompanion(WorkoutSetResult r) =>
      WorkoutSetResultsCompanion.insert(
        ...
        avgSpeed: Value(r.avgSpeed),
        avgCadence: Value(r.avgCadence),
        avgPulse: Value(r.avgPulse),
        ascentMeters: Value(r.ascentMeters),
        descentMeters: Value(r.descentMeters),
        avgPace: Value(r.avgPace),
        steps: Value(r.steps),
        side: Value(r.side),
